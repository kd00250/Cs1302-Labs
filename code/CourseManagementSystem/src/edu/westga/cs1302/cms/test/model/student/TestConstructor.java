...
class TestConstructor {
	...
	@Test
	void testNullName() {
		assertThrows(IllegalArgumentException.class, ()->{new Student(null, 85);});
	}

	@Test
	void testNameTooShort() {
		assertThrows(IllegalArgumentException.class, ()->{new Student("12", 72);});
	}
	...
	void testGradeIsLessThanZero() {
		assertThrows(IllegalArgumentException.class, ()->{new Student("12", -1);});
	}
	
	@Test
	void testGradeIsGreaterThanOneHundred() {
		assertThrows(IllegalArgumentException.class, ()->{new Student("12", 101);});
	}
